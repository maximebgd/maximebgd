...
USER_NAME = os.environ['USER_NAME'] # 'maximebgd'
QUERY_COUNT = {'user_getter': 0, 'graph_repos': 0, 'recursive_loc': 0, 'graph_commits': 0, 'loc_query': 0}
...
def graph_repos(owner_affiliation, cursor=None, add_loc=0, del_loc=0):
    """
...
if __name__ == '__main__':
    """
    Maxime Bégoud (maximebgd), 2026
    Adapted from Andrew6rant's self-updating README (github.com/Andrew6rant/Andrew6rant)
    """
    ...
    # TODO: remplace la date ci-dessous par ta vraie date de naissance (année, mois, jour)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2003, 12, 1))
